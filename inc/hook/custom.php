...
if ( ! function_exists( 'easy_commerce_footer_copyright' ) ) :
	...
	function easy_commerce_footer_copyright() {
		...
		// Powered by content.
		$powered_by_text = sprintf( esc_html__( 'Easy Commerce by %s', 'easy-commerce' ), '<a target="_blank" rel="designer" href="http://wenthemes.com/">' . esc_html__( 'WEN Themes', 'easy-commerce' ) . '</a>' . esc_html__( ' . پارسی ساز : ', 'easy-commercer' ) .  '<a target="_blank" href="https://mandegarweb.com/">' . esc_html__( 'ماندگار وب', 'easy-commercer' ) . '</a>' );
